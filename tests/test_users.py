...
def register_user(test_client, seed_roles):
...
# def test_register_user(test_client, seed_roles):

#     response = register_user(test_client, seed_roles)

#     assert response.status_code == 201
#     assert response.json()["email"] == test_user_account.get("email","")

# def test_register_duplicate_user(test_client, seed_roles):
...
# def test_get_all_users(test_client, seed_roles):
#     response = test_client.get("/api/v1/users")
#     assert response.status_code == 200
#     assert isinstance(response.json(), list)


# def test_get_user_by_id(test_client, seed_roles):

#     create_response = register_user(test_client, seed_roles)
...
# def test_update_user(test_client, seed_roles):
...
# def test_delete_user(test_client, seed_roles):
